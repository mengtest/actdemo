...
public class IRunController : StateMachineBehaviour
{
	...
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        AudioManager.Instance.PlayRunAudio(animator.GetComponent<AnimatorComponent>().mObj);
	}

    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        AudioManager.Instance.StopRunAudio(animator.GetComponent<AnimatorComponent>().mObj);
    }
}
