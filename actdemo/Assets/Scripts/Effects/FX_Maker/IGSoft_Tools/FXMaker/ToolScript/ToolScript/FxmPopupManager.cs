	...
	public void ShowHierarchyObjectPopup(string scriptFilename, Object selObj)
	{
		if (scriptFilename != null)
		{
			...
			if (m_CurrentHierarchyPopup == null)
				m_CurrentHierarchyPopup	= UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_ToolPopupGameObject, "Assets/Scripts/Effects/FX_Maker/IGSoft_Tools/FXMaker/ToolScript/ToolScript/FxmPopupManager.cs (395,31)", scriptFilename) as FxmPopup;
			if (m_CurrentHierarchyPopup != null)
