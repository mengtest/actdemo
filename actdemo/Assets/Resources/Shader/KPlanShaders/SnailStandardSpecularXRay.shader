Shader "SnailStandardSpecularXRay" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
			#pragma surface SnailStandardSurfaceSpecular SnailStandardSpecular fullforwardshadows addshadow keepalpha vertex:SnailStandardSurfaceVertex exclude_path:prepass exclude_path:deferred noforwardadd nodynlightmap nodirlightmap
			#pragma only_renderers d3d9 d3d11 d3d11_9x opengl gles gles3 metal
			#pragma target 3.0
